...
REM
REM Generated by Vivado on Mon Apr 20 22:06:46 -0400 2026
...
echo "xvlog --incr --relax -prj led_flash_tb_vlog.prj"
call xvlog  --incr --relax -prj led_flash_tb_vlog.prj -log xvlog.log
