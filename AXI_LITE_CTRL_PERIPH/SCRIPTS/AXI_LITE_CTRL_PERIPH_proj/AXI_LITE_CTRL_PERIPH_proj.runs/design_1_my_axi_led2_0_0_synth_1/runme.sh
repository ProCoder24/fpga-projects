...
HD_PWD='C:/FPGA/AXI_LITE_CTRL_PERIPH/SCRIPTS/AXI_LITE_CTRL_PERIPH_proj/AXI_LITE_CTRL_PERIPH_proj.runs/design_1_my_axi_led2_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_my_axi_led2_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_my_axi_led2_0_0.tcl
